...
int main()
{
	...
	std::shared_ptr<Light> key = std::make_shared<Light>(lux::Vector(-0.0, 0.5, 2.0), lux::Vector(-1, -1, -1), 20, 20, 20, 0.1);
	key->setColor(lux::Color(0.6, 0.2, 0.4, 0.5));
	std::shared_ptr<Light> fill = std::make_shared<Light>(lux::Vector(0.0, -2.4, 0.2), lux::Vector(-1, -1, -1), 20, 20, 20, 0.1);
